{{--
=============================================================================
E-Mail: Freitext-Antwort des Händlers zum Preisvorschlag (Shop)
=============================================================================
Erwartet: $proposal, $watch (nullable), $tenantName, $messageText.
=============================================================================
--}}
@php
...
<head>
    ...
    <title>Nachricht von {{ $tenantName }}</title>
</head>
<body style="margin:0; padding:0; background-color:#f5f5f4; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
        Nachricht von {{ $tenantName }} zu Ihrem Preisvorschlag.
    </div>
                    ...
                    <tr>
                        <td style="background-color:#ffffff; border-radius:24px; border:1px solid #e7e5e4; overflow:hidden;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                {{-- Nachricht des Händlers --}}
                                <tr>
                                    <td style="padding:36px 40px 0 40px;">
                                        <p style="margin:0; font-size:15px; line-height:1.8; color:#3f3f46; white-space:pre-line;">{{ $messageText }}</p>
                                    </td>
                                </tr>
                                                ...
                                                <tr>
                                                    @if ($photoSrc)
                                                        <td width="104" style="padding:14px 0 14px 14px;" valign="top">
                                                            <img src="{{ $photoSrc }}" alt="{{ $watch->fullName() }}" width="88" height="88"

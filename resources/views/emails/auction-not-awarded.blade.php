{{--
=============================================================================
E-Mail: Auktion beendet — kein Zuschlag (Limit nicht erreicht) (Modul 8b)
=============================================================================
WICHTIG: Das Limit (reserve_price) wird NIE genannt — nur der Hinweis,
dass es nicht erreicht wurde. Lädt zum Nachverkaufs-Kontakt ein.
Erwartet: $bid, $lot, $auction, $watch, $tenantName.
=============================================================================
--}}
@php
...
<body style="margin:0; padding:0; background-color:#f5f5f4; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
        Die Auktion ist beendet — das Limit des Einlieferers wurde leider nicht erreicht.
    </div>
                    ...
                    <tr>
                        <td style="background-color:#ffffff; border-radius:24px; border:1px solid #e7e5e4; overflow:hidden;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                {{-- Neutrale dunkle Kopfzeile: endgültig, aber kein Alarm --}}
                                <tr>
                                    <td style="background-color:#3f3f46; padding:36px 40px;" align="center">
                                        <p style="margin:0; font-size:12px; font-weight:600; letter-spacing:3px; text-transform:uppercase; color:#d4d4d8;">
                                            Auktion beendet — kein Zuschlag
                                        </p>
                                        <p style="margin:12px 0 0 0; font-size:40px; font-weight:700; color:#ffffff; letter-spacing:-1px;">
                                            {{ $formatEur($bid->amount) }}
                                        </p>
                                        <p style="margin:8px 0 0 0; font-size:14px; color:#d4d4d8;">
                                            Ihr Höchstgebot · Los {{ $lot->lot_code }} · {{ $auction->title }}
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:36px 40px 0 40px;">
                                        ...
                                        <p style="margin:14px 0 0 0; font-size:15px; line-height:1.6; color:#3f3f46;">
                                            die Auktion „{{ $auction->title }}“ ist beendet. Ihr Gebot über
                                            <strong>{{ $formatEur($bid->amount) }}</strong> war das höchste
                                            Gebot für dieses Los — das Limit des Einlieferers wurde jedoch
                                            nicht erreicht, daher konnte <strong>kein Zuschlag</strong>
                                            erteilt werden. Ihr Gebot ist damit erloschen; es entstehen
                                            Ihnen keine Verpflichtungen.
                                        </p>
                                        <p style="margin:14px 0 0 0; font-size:15px; line-height:1.6; color:#3f3f46;">
                                            Sie haben weiterhin Interesse an dieser Uhr? Antworten Sie
                                            einfach auf diese E-Mail — gerne sprechen wir mit dem
                                            Einlieferer über eine Möglichkeit im Nachverkauf.
                                        </p>
                                    </td>
                                </tr>

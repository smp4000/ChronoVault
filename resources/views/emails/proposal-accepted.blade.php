{{--
=============================================================================
E-Mail: Preisvorschlag angenommen — Zuschlag mit Zahlungsinfos (Shop)
=============================================================================
Erwartet: $watch, $buyer, $proposal, $tenantName, $amount, $accountHolder,
$iban, $bic, $remittance, $qrPng (binär|null), $invoiceNumber, $hasAddress.
=============================================================================
--}}
@php
...
<head>
    ...
    <title>Preisvorschlag angenommen</title>
</head>
<body style="margin:0; padding:0; background-color:#f5f5f4; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
        Ihr Preisvorschlag wurde angenommen — die Zahlungsinformationen für {{ $watch->fullName() }} finden Sie hier.
    </div>
                                ...
                                <tr>
                                    <td style="background-color:#047857; padding:36px 40px;" align="center">
                                        <p style="margin:0; font-size:12px; font-weight:600; letter-spacing:3px; text-transform:uppercase; color:#a7f3d0;">
                                            Ihr Preisvorschlag wurde angenommen
                                        </p>
                                ...
                                <tr>
                                    <td style="padding:36px 40px 0 40px;">
                                        ...
                                        <p style="margin:14px 0 0 0; font-size:15px; line-height:1.6; color:#3f3f46;">
                                            gute Nachrichten: Wir nehmen Ihren Preisvorschlag an — damit ist
                                            der <strong>verbindliche Kauf</strong> zum Preis von
                                        ...
                                        @unless ($hasAddress)
                                            <p style="margin:14px 0 0 0; font-size:15px; line-height:1.6; color:#3f3f46;">
                                                ...
                                                Lieferanschrift</strong>, damit wir die Uhr versenden können.
                                            </p>
                                        @endunless
                                    </td>
                                </tr>
                                                    ...
                                                    <td style="padding:20px 22px;" valign="top">
                                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding:7px 0; font-size:13px; font-weight:600; color:#047857;" align="right">{{ $formatEur($amount) }}</td>
                                                            </tr>
                                                            <tr>

{{--
=============================================================================
E-Mail: Preisvorschlag an den Händler (intern, Modul Shop)
=============================================================================
Erwartet: $watch, $proposal (proposed_price/name/email/message),
$tenantName, $panelUrl.
--}}
@php
...
<body style="margin:0; padding:0; background-color:#f5f5f4; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
        {{ $proposal['name'] }} schlägt {{ $formatEur($proposal['proposed_price']) }} für {{ $watch->fullName() }} vor.
    </div>
                                    ...
                                    <td style="padding:24px 40px 0 40px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding:9px 0; border-bottom:1px solid #f4f4f5; font-size:14px; font-weight:600; color:#18181b;" align="right">{{ $proposal['name'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:9px 0; border-bottom:1px solid #f4f4f5; font-size:14px; color:#71717a;">E-Mail</td>
                                                <td style="padding:9px 0; border-bottom:1px solid #f4f4f5; font-size:14px; font-weight:600; color:#18181b;" align="right">{{ $proposal['email'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:9px 0; border-bottom:1px solid #f4f4f5; font-size:14px; color:#71717a;">Preisvorschlag</td>
                                                <td style="padding:9px 0; border-bottom:1px solid #f4f4f5; font-size:14px; font-weight:700; color:#1e40af;" align="right">{{ $formatEur($proposal['proposed_price']) }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                            ...
                                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc; border-radius:16px;">
                                                <tr>
                                                    <td style="padding:18px 22px;">
                                                        ...
                                                        <p style="margin:8px 0 0 0; font-size:14px; line-height:1.7; color:#3f3f46; white-space:pre-line;">{{ $proposal['message'] }}</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <tr>
                                    <td style="padding:28px 40px 36px 40px;" align="center">
                                        ...
                                        <p style="margin:14px 0 0 0; font-size:12px; color:#a1a1aa;">
                                            Einfach auf diese E-Mail antworten — die Antwort geht direkt an {{ $proposal['name'] }}.
                                        </p>
                                    </td>
                                </tr>
                            </table>

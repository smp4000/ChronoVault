...
use App\Support\MediaLibrary\TenantMediaUrlGenerator;
...
return [
     ...
     */
    // ChronoVault: tenant-isolierte URLs über die stancl-Asset-Route
    // (tenant_asset) — Storage::url() zeigte auf den zentralen Symlink.
    'url_generator' => TenantMediaUrlGenerator::class,

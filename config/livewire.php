...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Tenancy-fähig (wie die Livewire-Update-Route im TenancyServiceProvider):
        // Uploads auf Tenant-Domains brauchen die Tenant-Session/-Storage,
        // sonst 419; auf zentralen Domains läuft die Route dank 'universal'
        // ohne Tenancy weiter. 'web' wird von Livewire automatisch vorangestellt,
        // die Middleware-Priorität sortiert die Tenancy-Initialisierung vor StartSession.
        'middleware' => [
            'universal',

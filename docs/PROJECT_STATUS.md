...
- Versicherungs-PDF: `App\Services\InventoryReportService` (Bestand ohne Verkauft; Kommission optional + gekennzeichnet; Wert-Fallback Marktwert → Angebotspreis → Einkaufspreis mit Quellen-Ausweis; EK-UNTERGRENZE: Marktwert < EK → EK + Alterszuschlag seit Kaufdatum [1. Jahr +10 %, 2. Jahr +15 %, ab 3. Jahr +20 %], Quelle z. B. „EK +10 % (1. Jahr)"; GD-Thumbnails; Gesamtsumme + Stichtag) + `pdf/inventory`-View; Header-Action „Versicherungsliste (PDF)" auf der Bestandsliste (Toggles: Kommission, Einkaufspreise)
- Wert-Zertifikat je Uhr (Versicherungs-Zertifikat-Stil, Vorbild Juwelier-PROTECT): `InventoryReportService::renderCertificatePdf(Watch, issuedFor, includePurchase, maskSerial)` — gleiche Wert-Logik inkl. EK-Untergrenze; Kenndaten (Referenz, Seriennummer optional geschwärzt, Kaliber, Material, Durchmesser, Baujahr, Zustand, Zubehör, Besonderheiten), Kaufdatum/-preis abschaltbar, Versicherungswert mit Quelle + Wert-Stand, Hauptfoto groß + Foto-Strip mit Perspektiven-Labels, Bestätigungstext, Ort/Datum/Unterschrift-Zeile, Footer mit Steuernummer/USt-IdNr.; Zertifikat-Nr. = Lagernummer sonst CV-<ID-Prefix>; View `pdf/certificate`; Header-Action „Zertifikat (PDF)" auf der Uhr-Edit-Seite (Textarea „Ausgestellt für" vorbefüllt mit Betriebsdaten, Toggles Kaufdaten/Seriennummer-Maskierung)
